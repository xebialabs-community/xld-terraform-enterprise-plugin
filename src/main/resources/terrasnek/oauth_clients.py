...
class TFEOAuthClients(TFEEndpoint):
    ...
    def __init__(self, base_url, organization_name, headers):
        ...
        self._org_base_url = "{base_url}/organizations/{organization_name}/oauth-clients".format(base_url=base_url, organization_name=organization_name)
        self._oauth_clients_base_url = "{base_url}/oauth-clients".format(base_url)
